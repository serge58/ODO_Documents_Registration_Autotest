...
public interface IHighlightConstants {
	public static final String SCRIPT_UNHIGHLIGHT_ELEMENT = "var elem = arguments[0] " + 
	...
	public static final String SCRIPT_GET_ELEMENT_BORDER = /** Returns all border properties of the specified element as String,
